...
FusionResult mlir::hcl::canFuseLoops(AffineForOp srcForOp, AffineForOp dstForOp,
...
void mlir::hcl::fuseLoops(AffineForOp srcForOp, AffineForOp dstForOp,
...
/// returns false otherwise.
bool mlir::hcl::getLoopNestStats(AffineForOp forOpRoot, LoopNestStats *stats) {
...
int64_t mlir::hcl::getComputeCost(AffineForOp forOp, LoopNestStats &stats) {
...
bool mlir::hcl::getFusionComputeCost(AffineForOp srcForOp, LoopNestStats &srcStats,
...
/// 'dstOps'.
void mlir::hcl::gatherProducerConsumerMemrefs(
