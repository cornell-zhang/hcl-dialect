...
usage = """
Usage: python3 scripts/add_license_header.py <file1 file2 ...|all>
Add license header to the target files. If file is "all", add license header
to all git-tracked files.
Examples:
 - python3 scripts/add_license_header.py all
"""
...
FMT_MAP = {
    ...
    "html": header_mdstyle,
    "bat": header_cmdstyle,
    "mlir": header_groovystyle,
    "dockerfile": header_pystyle,
    "td": header_cstyle,
}
