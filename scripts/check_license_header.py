...
usage = """
Usage: python3 scripts/check_license_header.py <commit|"all">
Run license header check that changed since <commit>. If <commit> is "all",
check all files.
Examples:
 - Compare last one commit: python3 scripts/check_license_header.py HEAD~1
 - Compare against origin: python3 scripts/check_license_header.py origin/main
 - Check all files: python3 scripts/check_license_header.py all
"""
