...
module {
  func @top(%arg0: memref<10x32xi32>) -> memref<10x32xi32> attributes {itypes = "s", otypes = "s"} {
    ...
    %1 = hcl.create_loop_handle "i"
    %2 = hcl.create_loop_handle "j"
    ...
    %5 = hcl.create_loop_handle "i"
    %6 = hcl.create_loop_handle "j"
    affine.for %arg1 = 0 to 10 {
      affine.for %arg2 = 0 to 32 {
    ...
    %9 = hcl.create_loop_handle "i"
    %10 = hcl.create_loop_handle "j"
    affine.for %arg1 = 0 to 10 {
      affine.for %arg2 = 0 to 32 {
